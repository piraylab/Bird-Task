...
jsPsych.plugins['comprehension2'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var prompts = [
      ...
      "</b>&nbsp;&nbsp; 2. The bag will fall near the bird, but the exact position will be random.",
      "</b>&nbsp;&nbsp; 3. Your best strategy is to keep the bucket directly under the bird (from your estimation).",
      "</b>&nbsp;&nbsp; 4. The best guess for the bird's new position is its position on the previous trial.",
      "</b>&nbsp;&nbsp; 5. How many birds total are in the game?",
    ];
