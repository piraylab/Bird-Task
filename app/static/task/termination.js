...
jsPsych.plugins["termination"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial.pages = [
      ...
      '<p style="font-size:20px" You might still be eligible for a partial payment. <br><br> Please click the next button to quit the game and then return your submission by closing the survey and choosing "Stop Without Completing" on Prolific.</p>',
    ];
    //
