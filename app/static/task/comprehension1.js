...
jsPsych.plugins['comprehension1'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var prompts = [
      "</b>&nbsp;&nbsp; 1. Your goal is to collect as much coin as you can.",
      "</b>&nbsp;&nbsp; 2. You can move the bucket both when the screen is clear and when it is opaque.",
      "</b>&nbsp;&nbsp; 3. If you leave the bucket in one place for a long time, we might end the game early.",
      "</b>&nbsp;&nbsp; 4. You will receive bonus based on the number of coins you collect.",
    ];
